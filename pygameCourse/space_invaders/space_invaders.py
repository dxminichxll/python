...
from pygame.constants import K_SPACE, KEYDOWN, KSCAN_PAGEDOWN
...
class Game():
    ...
    def shift_aliens(self):
        ...
        # Determine if alien group has hit edge
        shift = False
        ...
        if shift:
            ...
            for alien in self.alien_group.sprites():
                ...
                # Reverse the direction and move the alien off the edge so 'shift' doesn't trigger again
                alien.direction = -1 * alien.direction
                alien.rect.x += alien.direction * alien.velocity

                # Check if alien reached the ship
    ...
    def check_collisions(self):
        ...
        # See if any bullet in the player bullet group hit and alien in the alien group
    ...
    def check_round_completion(self):
        ...
        # If the alien group is empty, round completed
    ...
    def check_game_status(self, main_text, sub_text):
        ...
        # Empty the bullet groups and reset and remaining aliens
        ...
        # Check if game is over or of it is a simple round reset
...
class PlayerBullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # If bullet is off screen, kill it
