...
title_text = font.render("Kanye dog", True, WHITE)
...
bark_sound = pygame.mixer.Sound("give_us_what_we_need.wav")
miss_sound = pygame.mixer.Sound("miss_sound.wav")
pygame.mixer.music.load("On_Sight.wav")
...
pygame.mixer.Channel(0).play(pygame.mixer.Sound('On_Sight.wav'))
running = True
while running:
    ...
    if player_rect.colliderect(burger_rect):
        ...
        #     pygame.mixer.music.play()
        pygame.mixer.Channel(1).play(pygame.mixer.Sound('give_us_what_we_need.wav'))
        burger_rect.topleft = (random.randint(0, WINDOW_WIDTH-32), -BUFFER_DISTANCE)
