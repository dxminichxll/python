...
class Game():
    ...
    def draw(self):
        ...
        # Add the monster colours to a list wheere the index of the colour matches target_monster images
    ...
    def check_collisions(self):
        ...
        # We must test the type of the monster to see it matches the type of our target monster
    ...
    def start_new_round(self):
        ...
        # Provide score bonus based on how quickly the round was finished
