...
def main():
    ...
    sun_center = height - border_size  # aligns the center of the sun along the edge of the border
    ...
    draw_circle_fill(cr, width/2, sun_center, sun_size, sun_r, sun_g, sun_b)  # draw sun
