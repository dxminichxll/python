...
#     print(x, y)
#
# times2 = [[(i, i * j) for j in range(1, 11)] for i in range(1, 11)]  # nested comprehension
# print(times)

for x, y in ((i, i * j) for i in range(1, 11) for j in range(1, 11)):
    print(x, y)
# ^^ this is a generator expression and it isn't generating the entire list in memory