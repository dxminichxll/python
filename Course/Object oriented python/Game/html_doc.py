...
class HtmlDoc(object):
    ...
    # This class is composed of the 3 other classes, this is composition

    def add_tag(self, name, contents):
        # The HtmlDoc class is given an add_tag method which delegates the job of adding a tag to its
    ...
    def display(self, file=None):
        ...
        print('<html>', file=file)
#       apart from the 2 print functions, the remaining content is delegated to the appropriate classes
